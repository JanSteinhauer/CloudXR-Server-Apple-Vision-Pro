...
#define NV_RPC_CLIENT_C_API
    ...
    typedef struct
    {
        bool openxr_runtime_running;      // true if OpenXR runtime is running, false otherwise
        bool openxr_app_connected;        // true if OpenXR application is connected, false otherwise
        bool cloudxr_client_connected;    // true if CloudXR streaming client is connected, false otherwise
     ...
     *
     * @param pipe_name The named pipe endpoint, can be nullptr for default "cloudxr-runtime"
     * @param client_out Output parameter for the created client handle
     * @return NV_RPC_SUCCESS on success, error code on failure
     */
    NV_RPC_CLIENT_C_API nv_rpc_result_t nv_rpc_client_create(const char *pipe_name, nv_rpc_client_t *client_out);
     ...
     * @return NV_RPC_SUCCESS on success, error code on failure
     */
    NV_RPC_CLIENT_C_API nv_rpc_result_t nv_rpc_client_destroy(nv_rpc_client_t client);
     ...
     * @return NV_RPC_SUCCESS on success, error code on failure
     */
    NV_RPC_CLIENT_C_API nv_rpc_result_t nv_rpc_client_connect(nv_rpc_client_t client);
     ...
     * @return NV_RPC_SUCCESS on success, error code on failure
     */
    NV_RPC_CLIENT_C_API nv_rpc_result_t nv_rpc_client_disconnect(nv_rpc_client_t client);
     ...
     * @return NV_RPC_SUCCESS on success, error code on failure
     */
    NV_RPC_CLIENT_C_API nv_rpc_result_t nv_rpc_client_start_cxr_service(nv_rpc_client_t client, const char *service_version, size_t service_version_length);
     ...
     * @return NV_RPC_SUCCESS on success, error code on failure
     */
    NV_RPC_CLIENT_C_API nv_rpc_result_t nv_rpc_client_stop_cxr_service(nv_rpc_client_t client);
     ...
     * @return NV_RPC_SUCCESS on success, error code on failure
     */
    NV_RPC_CLIENT_C_API nv_rpc_result_t nv_rpc_client_get_supported_versions(nv_rpc_client_t client, nv_string_array_t *versions_out);
     ...
     * @return NV_RPC_SUCCESS on success, error code on failure
     */
    NV_RPC_CLIENT_C_API nv_rpc_result_t nv_rpc_client_get_cxr_service_json_path(nv_rpc_client_t client, char *path_out, size_t path_size);
     ...
     * @return NV_RPC_SUCCESS on success, error code on failure
     */
    NV_RPC_CLIENT_C_API nv_rpc_result_t nv_rpc_client_get_crypto_key_fingerprint(nv_rpc_client_t client, nv_crypto_algorithm_t algorithm, char *fingerprint_out, size_t fingerprint_size);
     ...
     * @return NV_RPC_SUCCESS on success, error code on failure
     */
    NV_RPC_CLIENT_C_API nv_rpc_result_t nv_rpc_client_free_string_array(nv_string_array_t *string_array);

    /**
     * @brief Get a human-readable error message for an error code
     *
     * @param result The error code
     * @return A string describing the error (valid until next call to this function)
     */
    NV_RPC_CLIENT_C_API const char *nv_rpc_client_get_error_string(nv_rpc_result_t result);
     ...
     * @return NV_RPC_SUCCESS on success, error code on failure
     */
    NV_RPC_CLIENT_C_API nv_rpc_result_t nv_rpc_client_set_client_id(nv_rpc_client_t client, const char *clientId, size_t clientIdLength, unsigned char *token, size_t tokenSize, size_t *tokenSizeOut);
     ...
     * @return NV_RPC_SUCCESS on success, error code on failure
     */
    NV_RPC_CLIENT_C_API nv_rpc_result_t nv_rpc_client_get_cxr_service_status(nv_rpc_client_t client, nv_service_status_t *status_out);
     ...
     * @return NV_RPC_SUCCESS on success, error code on failure
     */
    NV_RPC_CLIENT_C_API nv_rpc_result_t nv_rpc_client_shutdown_manager(nv_rpc_client_t client);
